...
interface ToolViewProps {
  onBack: () => void;
  toolId: string; // NEW: Receive which tool to display
}

export function ToolView({ onBack, toolId }: ToolViewProps) {
    ...
    <div className="bg-gray-50 flex-1 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center px-6">
        <div className="text-center">
          ...
          <p className="text-xs text-gray-500 mt-3">Component coming in v1.2.3</p>
          {tool.hasChatbar && (
